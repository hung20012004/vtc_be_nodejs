...
import importRouter from './api/routes/inventory/inventoryImport.route';
...
app.use('/api/v1/inventory/imports', importRouter);
app.use('/api/v1/inventory/exports', exportRouter);
app.use('/api/v1/inventory/checks', checkRouter);
app.use('/api/v1/inventory/branches', branchInventoryRouter);
