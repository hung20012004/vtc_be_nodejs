...
import * as PermissionModel from '../../models/authentication/permission.model';
import { createActivityLog } from '../../models/authentication/user_activity_logs.model'; // 1. Import hàm ghi log
import { User } from '../../types/authentication/user.type'; // Import User type để TypeScript hiểu req.user
