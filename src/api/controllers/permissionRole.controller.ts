...
import { findRoleById } from '../models/role.model'; // Import model để lấy tên role
import { findPermissionById } from '../models/permission.model'; // Import model để lấy tên permission
